...
import { signup, signin, logout, sendVerifyOtp, verifyEmail, isAuthenticated, sendResetOtp, resetPassword, getPatientProfile } 
...
functionRouter.get('/profile', userToken, getPatientProfile);
